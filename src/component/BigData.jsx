          ...
          <div className="row align-items-center">
            <div className="col-md-6 text-center text-md-start mb-4 mb-md-0">
              ...
              <p className="mb-4 lead">
                Elevate your Data Experience with trident and Also Experience Seamless
                Data Experience Management with trident
              </p>
      ...
      <section className="bg-black text-white py-5">
        <div className="container py-4">
          <div className="text-center mb-5">
            <h2 className="display-4 mb-4">Data Collections</h2>
            <p className="lead">
              For any kind of enquiry related to particular forms of data click on the below mentioned WhatsApp button
            </p>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-4 col-md-6">
              <a href="https://api.whatsapp.com/send?phone=+917385869036&text= Hey I want Database" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Students</h5>
                      <p className="card-text text-dark mb-0">Get it Now</p>
                    </div>
                  </div>
                </div>
              </a>
            ...
            {/* Stock Market Card */}
            <div className="col-lg-4 col-md-6">
              <a href="https://wa.me/+917385869036" 
                 className="text-decoration-none">
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    <div className="me-3">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Stock market data</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
              ...
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Real Estate</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
              ...
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Credit Card Data</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
              ...
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Car Owner</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
              ...
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Job Seeker Database</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    <div className="me-3">
                      <img src="buisnessman.jpg" 
                           className="rounded-circle"
                           style={{width: "50px", height: "50px"}}
                           alt="Business Man" />
                    </div>
                    <div>
                      <h5 className="card-title text-dark mb-1">Business Man Database</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    <div className="me-3">
                      <img src="salaried.png" 
                           className="rounded-circle"
                           style={{width: "50px", height: "50px"}}
                           alt="Salaried Person" />
                    </div>
                    <div>
                      <h5 className="card-title text-dark mb-1">Salaried Person Database</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
              ...
              <a href="https://wa.me/+917385869036" 
                ...
                <div className="card bg-warning bg-opacity-25 border-0 h-100">
                  <div className="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                      <h5 className="card-title text-dark mb-1">Many more Different Types of Data Available</h5>
                      <p className="card-text text-dark mb-0">Get It Now</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="card-body p-4">
                  ...
                  <ul className="list-unstyled mb-4">
                    ...
                    <li className="d-flex align-items-center mb-3">
                      ...
                      <span className="text-white">All legit database of respective field</span>
                    </li>
                    <li className="d-flex align-items-center mb-3">
                      <div className="rounded-circle bg-success d-flex align-items-center justify-content-center me-2" 
                           style={{width: "24px", height: "24px", minWidth: "24px"}}>
