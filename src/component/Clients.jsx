...
<section className="bg-black text-center">
  <div className="container-fluid">
    ...
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={solticAfrica} alt="Soltic Africa" className="img-fluid" />
        <h4 className="text-white mt-4">Soltic Africa</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={ons} alt="ONS Fresh" className="img-fluid" />
        <h4 className="text-white mt-4">ONS Fresh</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={jayram} alt="Jayram Transport Corp." className="img-fluid" />
        <h4 className="text-white mt-4">Jayram Transport Corp.</h4>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={dial} alt="Dial-a-Meal" className="img-fluid" />
        <h4 className="text-white mt-4">Dial-a-Meal</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={aptolink} alt="AptolinkPRO" className="img-fluid" />
        <h4 className="text-white mt-4">AptolinkPRO</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={anandRoad} alt="Anand Road Lines" className="img-fluid" />
  ...
  <div className="container-fluid mt-5">
    ...
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={ashoka} alt="Ashoka" className="img-fluid" />
        <h4 className="text-white mt-4">Ashoka</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={sanklecha} alt="Sanklecha" className="img-fluid" />
        <h4 className="text-white mt-4">Sanklecha</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={peak} alt="Peak Infrastructure" className="img-fluid" />
        <h4 className="text-white mt-4">Peak Infrastructure</h4>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={safeway} alt="Safeway" className="img-fluid" />
        <h4 className="text-white mt-4">Safeway</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={greenbrier} alt="Green Brier" className="img-fluid" />
        <h4 className="text-white mt-4">Green Brier</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={fluid} alt="Fluid Robotics" className="img-fluid" />
  ...
  <div className="container-fluid mt-5">
    ...
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={mahindra} alt="Mahindra" className="img-fluid" />
        <h4 className="text-white mt-4">Mahindra</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={acma} alt="ACMA" className="img-fluid" />
        <h4 className="text-white mt-4">ACMA</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={kirloskar} alt="Kirloskar" className="img-fluid" />
        <h4 className="text-white mt-4">Kirloskar</h4>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={baxy} alt="Baxy" className="img-fluid" />
        <h4 className="text-white mt-4">Baxy</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={jayshree} alt="Jayashree" className="img-fluid" />
        <h4 className="text-white mt-4">Jayashree</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={aryan} alt="Aryan" className="img-fluid" />
  ...
  <div className="container-fluid mt-5">
    ...
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={wrestling} alt="Wrestling" className="img-fluid" />
        <h4 className="text-white mt-4">Wrestling</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={aanknaad} alt="Aanknaad" className="img-fluid" />
        <h4 className="text-white mt-4">Aanknaad</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={manatarang} alt="ManaTarang" className="img-fluid" />
        <h4 className="text-white mt-4">ManaTarang</h4>
      </div>
    </div>
    <div className="row">
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={stationers} alt="Online Stationers" className="img-fluid" />
        <h4 className="text-white mt-4">Online Stationers</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={snovel} alt="Snovel" className="img-fluid" />
        <h4 className="text-white mt-4">Snovel</h4>
      </div>
      <div className="col-lg-4 col-md-4 col-sm-12 mb-4">
        <img src={takerent} alt="Take Rent Pe" className="img-fluid" />
