...
function Footer() {
  return (
    <div>
      ...
      <footer className="bg-img background-size-contain" data-overlay-dark={7}>
          ...
          <div className="row mt-n2-6">
            <div className="col-md-4 col-lg-4  mt-2-6 ">
              <div className="pe-md-1-9 border-md-end border-color-light-white pb-1-9 pb-md-0 borders-bottom border-md-bottom-0 h-100">
                ...
                <ul className="footer-list ps-0">
                  ...
                  <li>
                    <i className="fas fa-mobile-alt text-primary "></i> +91
                    9172530151
                  </li>
            ...
            <div className="col-lg-3 col-md-3 col-6 mt-2-6">
              <div className="height-100">
                <p className="footer-title-style7 text-white text-start fs-4 ms-3">
                  Quick Links
                </p>
                <ul>
                  <li>
            ...
            <div className="col-lg-3 col-md col-6 mt-2-6">
              <div className="height-100">
                <p className="footer-title-style7 text-white fs-4 ms-3">
                  Products
                </p>
                <ul>
                  <li>
